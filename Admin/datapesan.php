    ...
    <div class="row no-gutters" style="margin-top: 87px">
      <div class="col-2 bg-dark pr-3 pt-2">
        <ul class="nav flex-column mb-3" style="margin-left: 9px">
          ...
          <li class="nav-item">
            <a class="nav-link text-white" href="#"><i class="fa fa-user" aria-hidden="true" style="padding: 10px"></i>Data Pesan/Contact</a>
          </li>
        </ul>
      </div>
      <div class="col-md-10">
        <div class="container">
          <div class="row me-4 ms-4" style="background-color: white">
            <div class="judul-produk">
              <h3 class="text-3 ms-4 me-4 p-2 text-center mt-3">DATA PESAN/CONTACT</h3>
            </div>
