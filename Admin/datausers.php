...
if(isset($_POST["cari"])) {
  ...
  $plg = cariuserspembeli($_POST["pencarian"]);
}
    ...
    <div class="row no-gutters" style="margin-top: 87px">
      <div class="col-2 bg-dark pr-3 pt-2">
        <ul class="nav flex-column mb-3" style="margin-left: 9px">
          ...
          <li class="nav-item">
            <a class="nav-link text-white" href=""><i class="fa fa-user" aria-hidden="true" style="padding: 10px"></i>Data Login User Pembeli</a>
            <hr class="bg-white" />
          </li>
          <li class="nav-item">
      ...
      <div class="row me-4 ms-4" style="background-color: white">
        <div class="judul-produk">
          <h3 class="text-3 ms-4 me-4 p-2 text-center mt-3">DATA LOGIN USER PEMBELI</h3>
        </div>
            ...
            <table class="table align-middle table-bordered mt-4">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td><?= $row["password"];?></td>
                  <td>
                    <a href="halamanubahusers.php?id=<?= $row["id"];?>" onclick="return confirm('Apakah anda yakin ingin mengubah data??');"><button type="button" class="btn btn-success btn-sm mt-2"><i class="fa fa-pencil"></i></button></a>
