...
if(isset($_POST["submit"])) {
  ...
  if(mysqli_affected_rows($connect) > 0) {
    ...
    document.location.href = '../folder produk/kue_mendut.php';
    </script>";
  } else {
    echo "
    <script>
...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="../folder css/folder style deskripsi produk/style_produk_kue_mendut1.css" />
    <link rel="stylesheet" href="../fontawesome/css/all.min.css" />
    <title>KUE MENDUT</title>
  </head>
  <body>
    <!-- Judul -->
    <div class="container conn-1 p-0">
      ...
      <div class="container">
        <div class="row row-produk">
          <div class="col-lg-5">
            <figure class="figure">
              <img src="../folder foto/foto11(11).png" class="figure-img img-fluid" style="border-radius: 5px" width="450px" id="MainImg"/>
              <figcaption class="figure-caption d-flex justify-content-evenly">
                <a href="#" class="bag1">
                  <img src="../folder foto/foto11(11).png" class="figure-img img-fluid" style="border-radius: 5px" width="70px" class="small-img"/>
                </a>
                <a href="#" class="bag2">
                  <img src="../folder foto detail produk/kue_mendut/foto1(1).png" class="figure-img img-fluid" style="border-radius: 5px" width="70px" class="small-img"/>
                </a>
                <a href="#" class="bag3">
                  <img src="../folder foto detail produk/kue_mendut/foto2(2).png" class="figure-img img-fluid" style="border-radius: 5px" width="70px" class="small-img"/>
                </a>
                <a href="#" class="bag4">
                  <img src="../folder foto detail produk/kue_mendut/foto3(3).png" class="figure-img img-fluid" style="border-radius: 5px" width="70px" class="small-img"/>
                </a>
                <a href="#" class="bag5">
                  <img src="../folder foto detail produk/kue_mendut/foto4(4).png" class="figure-img img-fluid" style="border-radius: 5px" width="70px" class="small-img"/>
                </a>
              </figcaption>
            </figure>
          </div>
          ...
          <div class="col-lg-7">
            ...
            <h3 class="text-muted mb-3">Rp 2.500</h3>
            <br />
            ...
            <div class="text-produk">
              <h5 class="text-1">
                Deskripsi Produk : <br />
                <br />
                Kue mendut merupakan hidangan penutup atau dessert. Kue ini dibuat dengan tepung ketan sebagai <br />
                bahan bakunya. Warnanya merah serta hijau. Dan kue mendut dibungkus menggunakan daun pisang atau plastik setelah disiram saus santan.
              </h5>
            </div>
