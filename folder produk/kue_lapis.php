...
if(isset($_POST["submit"])) {
  ...
  if(mysqli_affected_rows($connect) > 0) {
    ...
    document.location.href = '../folder produk/kue_lapis.php';
    </script>";
  } else {
    echo "
    <script>
...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="../folder css/folder style deskripsi produk/style_produk_kue_lapis.css" />
    <link rel="stylesheet" href="../fontawesome/css/all.min.css" />
    <title>KUE LAPIS</title>
  </head>
  <body>
    <!-- Judul -->
    <div class="container conn-1 p-0">
      ...
      <div class="container">
        <div class="row row-produk">
          <div class="col-lg-5">
            <figure class="figure">
              <img src="../folder foto/foto6(6).png" class="figure-img img-fluid" style="border-radius: 5px" width="450px" id="MainImg"/>
              <figcaption class="figure-caption d-flex justify-content-evenly">
                <a href="#" class="bag1">
                  <img src="../folder foto/foto6(6).png" class="figure-img img-fluid" style="border-radius: 5px" width="70px" class="small-img"/>
                </a>
                <a href="#" class="bag2">
                  <img src="../folder foto detail produk/kue_lapis/foto1(1).png" class="figure-img img-fluid" style="border-radius: 5px" width="70px" class="small-img"/>
                </a>
                <a href="#" class="bag3">
                  <img src="../folder foto detail produk/kue_lapis/foto2(2).png" class="figure-img img-fluid" style="border-radius: 5px" width="70px" class="small-img"/>
                </a>
                <a href="#" class="bag4">
                  <img src="../folder foto detail produk/kue_lapis/foto3(3).png" class="figure-img img-fluid" style="border-radius: 5px" width="70px" class="small-img"/>
                </a>
                <a href="#" class="bag5">
                  <img src="../folder foto detail produk/kue_lapis/foto4(4).png" class="figure-img img-fluid" style="border-radius: 5px" width="70px" class="small-img"/>
                </a>
              </figcaption>
            </figure>
          </div>
          ...
          <div class="col-lg-7">
            ...
            <div class="text-produk">
              <h5 class="text-1">
                Deskripsi Produk : <br />
                <br />
                Kue lapis adalah makanan khas Indonesia. Kue ini biasanya terdiri dari dua warna yang berlapis-lapis, <br />
                ini yang memberi nama kue ini. Kue ini dibuat dari tepung beras, tepung kanji, santan, gula pasir, garam dan pewarna.
              </h5>
            </div>
