      ...
      <div class="container">
        <div class="row row-produk">
          ...
          <div class="col-lg-7">
            ...
            <h3 class="text-muted mb-3">Rp 4.000</h3>

            <div class="text-produk">
              <h5 class="text-1">
                Deskripsi Produk : <br />
                <br />
                Terbuat dari tepung beras dan digoreng membentuk seperti <br />
                panekuk dengan warna coklat gelap, memiliki rasa gurih dan manis <br />
                yang pas.
              </h5>
            </div>
