...
if(isset($_POST["submit"])) {
  ...
  if(mysqli_affected_rows($connect) > 0) {
    ...
    document.location.href = '../folder produk/kue_lumpur.php';
    </script>";
  } else {
    echo "
    <script>
...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="../folder css/folder style deskripsi produk/style_produk_kue_lumpur1.css" />
    <link rel="stylesheet" href="../fontawesome/css/all.min.css" />
    <title>KUE LUMPUR</title>
  </head>
  <body>
    <!-- Judul -->
    <div class="container conn-1 p-0">
      ...
      <div class="container">
        <div class="row row-produk">
          <div class="col-lg-5">
            <figure class="figure">
              <img src="../folder foto/foto7(7).png" class="figure-img img-fluid" style="border-radius: 5px" width="450px" id="MainImg"/>
              <figcaption class="figure-caption d-flex justify-content-evenly">
                <a href="#" class="bag1">
                  <img src="../folder foto/foto7(7).png" class="figure-img img-fluid" style="border-radius: 5px" width="70px" class="small-img"/>
                </a>
                <a href="#" class="bag2">
                  <img src="../folder foto detail produk/kue_lumpur/foto1(1).png" class="figure-img img-fluid" style="border-radius: 5px" width="70px" class="small-img"/>
                </a>
                <a href="#" class="bag3">
                  <img src="../folder foto detail produk/kue_lumpur/foto2(2).png" class="figure-img img-fluid" style="border-radius: 5px" width="70px" class="small-img"/>
                </a>
                <a href="#" class="bag4">
                  <img src="../folder foto detail produk/kue_lumpur/foto3(3).png" class="figure-img img-fluid" style="border-radius: 5px" width="70px" class="small-img"/>
                </a>
                <a href="#" class="bag5">
                  <img src="../folder foto detail produk/kue_lumpur/foto4(4).png" class="figure-img img-fluid" style="border-radius: 5px" width="70px" class="small-img"/>
                </a>
              </figcaption>
            </figure>
          </div>
          ...
          <div class="col-lg-7">
            ...
            <div class="text-produk">
              <h5 class="text-1">
                Deskripsi Produk : <br />
                <br />
                Kue ini memiliki citarasa manis gurih karena adanya pemakaian santan. <br />
                Saat digigit, kue ini lembut dan creamy yang dapat membelai lidah.
              </h5>
            </div>
