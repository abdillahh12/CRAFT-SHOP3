...
if(isset($_POST["submit"])) {
  ...
  if(mysqli_affected_rows($connect) > 0) {
    ...
    document.location.href = '../folder produk/kue_serabi.php';
    </script>";
  } else {
    echo "
    <script>
...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="../folder css/folder style deskripsi produk/style_produk_kue_serabi.css" />
    <link rel="stylesheet" href="../fontawesome/css/all.min.css" />
    <title>KUE SERABI</title>
  </head>
  <body>
    <!-- Judul -->
    <div class="container conn-1 p-0">
      ...
      <div class="container">
        <div class="row row-produk">
          <div class="col-lg-5">
            <figure class="figure">
              <img src="../folder foto/foto5(2).jpg" class="figure-img img-fluid" style="border-radius: 5px" width="450px" id="MainImg"/>
              <figcaption class="figure-caption d-flex justify-content-evenly">
                <a href="#" class="bag1">
                  <img src="../folder foto/foto5(2).jpg" class="figure-img img-fluid" style="border-radius: 5px" width="70px" class="small-img"/>
                </a>
                <a href="#" class="bag2">
                  <img src="../folder foto detail produk/kue_serabi/foto1.jpg" class="figure-img img-fluid" style="border-radius: 5px" width="70px" class="small-img"/>
                </a>
                <a href="#" class="bag3">
                  <img src="../folder foto detail produk/kue_serabi/foto2.jpeg" class="figure-img img-fluid" style="border-radius: 5px" width="70px" class="small-img"/>
                </a>
                <a href="#" class="bag4">
                  <img src="../folder foto detail produk/kue_serabi/foto3.jpg" class="figure-img img-fluid" style="border-radius: 5px" width="70px" class="small-img"/>
                </a>
                <a href="#" class="bag5">
                  <img src="../folder foto detail produk/kue_serabi/foto4.jpg" class="figure-img img-fluid" style="border-radius: 5px" width="70px" class="small-img"/>
                </a>
              </figcaption>
            </figure>
          </div>
          ...
          <div class="col-lg-7">
            ...
            <div class="text-produk">
              <h5 class="text-1">
                Deskripsi Produk : <br />
                <br />
                Kue serabi adalah makanan yang terbuat dari tepung beras yang dicampur dengan santan dan digoreng di atas arang mirip pancake ( roti loyang ) atau pancake.
              </h5>
            </div>
